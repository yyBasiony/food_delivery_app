            ...
            return Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Align(
                  ...
                  child: TextButton(
                      ...
                      child: Text('Skip', style: context.textTheme.headlineMedium?.copyWith(color: Colors.white)))),
              Expanded(
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Text(
                            ...
                            style: context.textTheme.labelSmall?.copyWith(color: AppColors.splashBackground)),
                      ],
                    );
                  },
                ),
              ...
              Column(children: [
                Padding(
                    ...
                    child: ElevatedButton(
                        ...
                        child: Text("Continue", style: context.textTheme.bodyMedium?.copyWith(color: AppColors.primaryColor)))),
                Padding(
