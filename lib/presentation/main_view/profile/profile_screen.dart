...
class ProfileScreen extends StatelessWidget {
  ...
  static const List<({IconData icon, String title, String route})>
      _profileListData = [
    ...
    (
      ...
      route: Routes.paymentSettingsScreen
    ),
    (
      icon: Icons.local_offer,
      title: 'My Voucher',
      route: Routes.myVoucherScreen
    ),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (_, index) => ListTile(
                ...
                leading:
                    Icon(_profileListData[index].icon, color: AppColors.grey),
                onTap: () =>
                    Navigator.pushNamed(context, _profileListData[index].route),
                title: Text(_profileListData[index].title,
                    style: context.textTheme.headlineMedium
                        ?.copyWith(color: AppColors.black)),
              ),
            ),
